...
# takes a cookbook name and returns all its recipes
...
call getRecipes('Delish');
# 09:39:49	call getRecipes('Delish')	Error Code: 1305. PROCEDURE mealplanning.getRecipes does not exist	0.00011 sec
